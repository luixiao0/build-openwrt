...
define Device/xiaomi_mir3g
  ...
  DEVICE_PACKAGES := kmod-mt7603e kmod-mt76x2 luci-app-mtwifi kmod-usb3 \
...
define Device/xiaomi_mir3p
  ...
  IMAGE/factory.bin := append-kernel | pad-to $$(KERNEL_SIZE) | append-ubi | \
	check-size
  DEVICE_PACKAGES := kmod-mt7615d luci-app-mtwifi kmod-usb3 kmod-usb-ledtrig-usbport \
	uboot-envtools
endef
...
define Device/xiaomi-ac2100
  ...
  IMAGE/breed-factory.bin := append-kernel | pad-to $$(KERNEL_SIZE) | \
							 ...
							 append-ubi | check-size $$$$(IMAGE_SIZE)
  DEVICE_VENDOR := Xiaomi
  DEVICE_PACKAGES := kmod-mt7603e kmod-mt7615e luci-app-mtwifi \
	uboot-envtools wpad-openssl
endef
