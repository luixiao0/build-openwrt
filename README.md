...
# 2020/9/24号说明
- [前3天左右编译lede源码会出现出错的情况，是源码自带某些插件有问题，我也不可能一直测试，今天我编译也发现v2ray也出错了，回退版本解决编译错误了，补丁我已经放在build/Lede_x86_64/patches文件上，002-text.patch就是，前面还有frb出错的，源码作者好像搞好了，最近几天大家使用Lienol或者project源码编译吧，这2个源码好像没发现错误](#/README.md)

- [大家如果编译的时候没乱搞而又出现编译错误的，要善于在各个作者源码的‘Issues’或者提问找答案](#/README.md)
