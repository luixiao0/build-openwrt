...
- 2020/9/19增加一个启动按钮。[[教程](https://github.com/danshui-git/shuoming/blob/master/%E6%89%8B%E5%8A%A8%E5%BC%80%E5%A7%8B.md)]，有独立按钮的话，你就可以每个机型都配套一个.yml文件，文件名字就取对应的机型，比如Lede_x86_64.yml，然后做.yml机型选择那里写上对应的机型Lede_x86_64，这样以后就可以单独的开关它了，每个机型都独立，还可以设置另外一个.yml文件启动全部机型，或者启动你需要的组合
