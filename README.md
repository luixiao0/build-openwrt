...
#
- 6、`SSH远程连接服务器配置固件`《[SSH连接教程](https://github.com/danshui-git/shuoming/blob/master/3SSH%E8%BF%9E%E6%8E%A5%E8%AF%B4%E6%98%8E.md)》，开启SSH远程连接服务修改固件配置，在build文件夹里面的对应机型文件夹的‘settings.ini’设置
#
